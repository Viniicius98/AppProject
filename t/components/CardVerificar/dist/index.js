...
function CardVerificar() {
    return (react_1["default"].createElement(Containerr, null,
        ...
        react_1["default"].createElement(AvatarContainerr, null,
            react_1["default"].createElement(Avatar, { source: require("../../assets/images/notificacaoed.jpg") })),
        react_1["default"].createElement(Themed_1.Text, { style: { fontSize: 12, fontWeight: "bold", textAlign: "center", marginBottom: 25 } }, "VERIFICAR NOTIFICA\u00C7\u00D5ES")));
}
exports["default"] = CardVerificar;
